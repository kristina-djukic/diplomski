  ...
  return (
    <div className="welcome-container">
      <div className="welcome-card">
        ...
        <p>
         In this survery you will be asked to answer a few questions about your musical background, as well as rate 50 songs and choose an emotion that each one evokes in you. If you do not know the song or need a reminder you can listen to a couple of seconds of the song. The survey takes approximately 10 minutes to complete.
        </p>
        <p>
